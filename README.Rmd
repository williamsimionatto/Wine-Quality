...
Que irão gerar uma variável de saída `quality`, a qual representa a pontuação do vinho, em uma escala de 0 a 10. Sendo 0 um vinho considerado `ruim` e 10 um vinho `bom`.
