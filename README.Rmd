...
É possível notar que os dados não estão distribuídos de maneira uniforme, pois em ambos os datasets há uma concentração de vinhos considerados `normais`, cerca de 80%.
